...
class Table {
     ...
     * @return null
     * @throws pallo\library\database\exception\DatabaseException when the field
     ...
     * @throws pallo\library\database\exception\DatabaseException when no valid string provided as name
     * @throws pallo\library\database\exception\DatabaseException when the name
     ...
     * @throws pallo\library\database\exception\DatabaseException when the index
     * is already set to this table
     */
