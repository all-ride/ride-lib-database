...
class SqliteDefiner extends AbstractDefiner {
     ...
     * @throws pallo\library\database\sqlite\exception\DatabaseException
     */
...
//        return $table;
     ...
     * @param pallo\library\database\definition\Table $table Table definition of the altered table
     * @return null
     */
...
//        }
    ...
    /**
     * Creates a new table
     * @param pallo\library\database\definition\Table $table Table definition for the new table
     * @return null
     */
     ...
     * @param string $tableName Plain name of the table
     * @param pallo\library\database\definition\Index $index Index to add
     * @return null
     */
     ...
     * @throws pallo\library\database\Exception\DatabaseException when the name is empty or not a string
     */
