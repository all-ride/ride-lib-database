...
use pallo\library\database\definition\ForeignKey;
...
class MysqlDefiner extends AbstractDefiner implements Utf8Converter {
     ...
     * @throws pallo\library\database\mysql\exception\DatabaseException
     */
     ...
     * @param pallo\library\database\definition\Table $table Definition of the
     * table
     ...
     * @param pallo\library\database\definition\Table $table Table definition of
     * the altered table
     * @return null
     */
     ...
     * @return null
     * @throws pallo\library\database\exception\DatabaseException when no fields
