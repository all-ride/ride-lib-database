...
class DatabaseManager {
     ...
     * @var string
     */
    const INTERFACE_DRIVER = 'pallo\\library\\database\\driver\\Driver';
     ...
     * @return pallo\library\database\driver\Driver Instance of the database
     * connection
     ...
     * @see pallo\library\database\driver\Driver
     */
     ...
     * @param pallo\library\database\driver\Driver $connection Instance of a
     * connection
     * @return pallo\library\database\definition\definer\Definer
     * @throws pallo\library\database\exception\DatabaseException when no
     ...
     * @param pallo\library\database\definition\definer\Definer $definer
