...
use pallo\library\database\manipulation\condition\SqlCondition;
use pallo\library\database\manipulation\expression\AliasExpression;
use pallo\library\database\manipulation\expression\CaseExpression;
use pallo\library\database\manipulation\expression\Expression;
...
use pallo\library\database\manipulation\expression\LimitExpression;
...
use pallo\library\database\manipulation\expression\SubqueryExpression;
...
use pallo\library\database\manipulation\statement\DeleteStatement;
...
class GenericStatementParser implements StatementParser {
     ...
     * @var pallo\łibrary\database\driver\AbstractDriver
     */
    protected $connection;

    /**
     * Construct a new statement parser
     * @param pallo\library\database\driver\AbstractDriver $connection
     ...
     * @throws pallo\library\database\exception\DatabaseException when the statement is not supported by this parser
     */
     ...
     * @throws pallo\library\database\exception\DatabaseException when no table was added to the statement
     */
     ...
     * @param pallo\library\database\manipulation\statement\manipulation\InsertStatement $statement
     * @return string SQL of the insert statement
     * @throws pallo\library\database\exception\DatabaseException when no table was added to the statement
     * @throws pallo\library\database\exception\DatabaseException when no values where added to the statement
     */
     ...
     * @param pallo\library\database\manipulation\statement\manipulation\SelectStatement $statement
     ...
     * @param pallo\library\database\manipulation\statement\manipulation\UpdateStatement $statement
     ...
     * @param pallo\library\database\manipulation\expression\condition\Condition $condition condition to translate into SQL
     * @return string SQL of the condition
     * @throws pallo\library\database\exception\DatabaseException when the condition is not supported by this parser
     */
     ...
     * @param pallo\library\database\manipulation\expression\condition\NestedCondition $condition
     * @param boolean useAlias
     ...
     * @param pallo\library\database\manipulation\expression\condition\SimpleCondition $condition
     * @param boolean useAlias
     ...
     * @param pallo\library\database\manipulation\expression\Expression $expression expression to translate into SQL
     * @param boolean $useAlias get the alias of the expression
     * @return string SQL of the expression
     * @throws pallo\library\database\exception\DatabaseException when the expression is not supported by this parser
     */
     ...
     * @param pallo\library\database\manipulation\expression\Expression $expression
     ...
     * @param pallo\library\database\manipulation\expression\FunctionExpression $function
     ...
     * @param pallo\library\database\manipulation\expression\MathematicalExpression $expression
     * @param boolean $useAlias
     ...
     * @param pallo\library\database\manipulation\expression\CaseExpression $case
     ...
     * @param pallo\library\database\manipulation\expression\ScalarExpression $expression
     ...
     * @param pallo\library\database\manipulation\expression\OrderExpression $order
     ...
     * @param pallo\library\database\manipulation\expression\LimitExpression $expression
