...
class DriverMock extends AbstractDriver {
     ...
     * @throws pallo\library\database\exception\DatabaseException when the provided identifier is empty or not a scalar value
     */
     ...
     * @throws pallo\library\database\exception\DatabaseException when the provided value is not a scalar value
     */
